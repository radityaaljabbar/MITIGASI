      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-b-lg shadow-md py-6 px-8">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <h3 className="text-lg font-medium text-gray-900">Tidak Ada Pengajuan {filterStatus !== 'all' && `dengan Status "${filterStatus === 'Menunggu' ? 'Menunggu' : filterStatus === 'Disetujui' ? 'Disetujui' : 'Ditolak'}"`}</h3>
                      ...
                      <dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">
                            {selectedApplication.jenis_keringanan === 'Pembebasan Biaya Penuh' ? 'Pembebasan Penuh' : formatCurrency(selectedApplication.jumlah_diajukan)}
                          </dd>
                        </div>
                        <div className="sm:col-span-2">
